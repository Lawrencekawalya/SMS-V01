...
@section('title', 'Edit Semester - ' . config('app.name', 'SMS-V01'))
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <select name="academic_year_id" id="academic_year_id" class="form-select @error('academic_year_id') is-invalid @enderror" required>
                  @foreach ($academicYears as $year)
                    <option value="{{ $year->id }}" {{ (string) old('academic_year_id', $semester->academic_year_id) === (string) $year->id ? 'selected' : '' }}>
              ...
              <div class="col-md-6">
                ...
                <select name="semester_number" id="semester_number" class="form-select @error('semester_number') is-invalid @enderror" required>
                  <option value="1" {{ old('semester_number', $semester->semester_number) == 1 ? 'selected' : '' }}>Semester 1</option>
                  <option value="2" {{ old('semester_number', $semester->semester_number) == 2 ? 'selected' : '' }}>Semester 2</option>
                  <option value="3" {{ old('semester_number', $semester->semester_number) == 3 ? 'selected' : '' }}>Semester 3 / Recess Term</option>
                </select>
              ...
              <div class="col-md-6">
                ...
                <input
                  ...
                  value="{{ old('add_drop_deadline', $semester->add_drop_deadline?->format('Y-m-d')) }}"
                />
