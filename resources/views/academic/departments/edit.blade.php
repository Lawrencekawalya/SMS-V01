...
@section('title', 'Edit Department - ' . config('app.name', 'SMS-V01'))
            ...
            <div class="mb-3">
              ...
              <select name="faculty_id" id="faculty_id" class="form-select @error('faculty_id') is-invalid @enderror" required>
                @foreach ($faculties as $faculty)
                  <option value="{{ $faculty->id }}" {{ (string) old('faculty_id', $department->faculty_id) === (string) $faculty->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
              ...
              <select name="hod_user_id" id="hod_user_id" class="form-select @error('hod_user_id') is-invalid @enderror">
                ...
                @foreach ($users as $user)
                  <option value="{{ $user->id }}" {{ (string) old('hod_user_id', $department->hod_user_id) === (string) $user->id ? 'selected' : '' }}>
